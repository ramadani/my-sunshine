package id.ramadani.mysunshine.data;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case WEATHER:
                ...
                break;
            case LOCATION:
                long _loc_id = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, values);
                if (_loc_id > 0)
                    returnUri = WeatherContract.LocationEntry.buildLocationUri(_loc_id);
                else
